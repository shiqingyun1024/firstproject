...
$(function () {
  ...
  var back;
    var standard;
    $.get('http://10.9.9.116:8080/financial/history_signal/image_data/2/standard',function(data){
        standard = data;
        createChart();

    });
    $.get('http://10.9.9.116:8080/financial/history_signal/image_data/2/back',function(data){
        back = data;
        createChart();
    });
